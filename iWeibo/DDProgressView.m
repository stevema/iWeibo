...
#define kProgressBarWidth	100.0f
...
- (id)initWithFrame:(CGRect)frame
{
	...
	if (self)
	{
		...
		self.innerColor = [UIColor colorWithRed:0.42f green:0.48f blue:0.55f alpha:1.00f];
		self.outerColor = [UIColor colorWithRed:0.42f green:0.48f blue:0.55f alpha:1.00f];
